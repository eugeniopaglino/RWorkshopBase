...
What we explored so far is part of the core R language. Indeed, except for the functions needed to time the code, we did not import any package. 
...
`coord_cartesian` controls the coordinates and can zoom on a part of the plot.
